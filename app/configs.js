...
const configs={
  ...
  full_list: JSON.parse(import.meta.env.VITE_FULL_LIST||'[3,10,29,14,19,27,18,9,26,15,24,22,12,11,5,23,4,6,28,7,24,8,2,25,1,13,21,16,17,20]'),
  home_list: JSON.parse(import.meta.env.VITE_HOME_LIST||'[3,10,29,14,19,27]'),
