    ...
    <div class="relative sm:container sm:mx-auto px-4 sm:px-6 lg:px-8 pt-14 sm:pt-20">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        <div class="lg:col-span-7">
          <div :class="['inline-flex items-center gap-2 rounded-full border border-ternary-light/60 dark:border-ternary-dark/80 bg-white/60 dark:bg-ternary-dark/40 backdrop-blur px-4 py-2', isRtl ? 'flex-row-reverse' : '']">
          ...
          <div class="mt-10 flex flex-wrap gap-2">
            <span class="rounded-full border border-ternary-light/60 dark:border-ternary-dark/70 px-3 py-1 text-xs text-ternary-dark/80 dark:text-ternary-light/80">Laravel</span>
            <span class="rounded-full border border-ternary-light/60 dark:border-ternary-dark/70 px-3 py-1 text-xs text-ternary-dark/80 dark:text-ternary-light/80">Vue</span>
            <span class="rounded-full border border-ternary-light/60 dark:border-ternary-dark/70 px-3 py-1 text-xs text-ternary-dark/80 dark:text-ternary-light/80">Nuxt</span>
            <span class="rounded-full border border-ternary-light/60 dark:border-ternary-dark/70 px-3 py-1 text-xs text-ternary-dark/80 dark:text-ternary-light/80">React</span>
            <span class="rounded-full border border-ternary-light/60 dark:border-ternary-dark/70 px-3 py-1 text-xs text-ternary-dark/80 dark:text-ternary-light/80">Tailwind</span>
          </div>
        </div>
        ...
        <div class="lg:col-span-5">
          <div class="relative mx-auto max-w-md">
            ...
            <div class="relative rounded-3xl border border-ternary-light/60 dark:border-ternary-dark/80 bg-white/60 dark:bg-ternary-dark/40 backdrop-blur p-4">
              <NuxtImg
                :src="configs.profile_photo"
                :alt="t('Mostefa Boudjema')"
                width="800"
                height="800"
